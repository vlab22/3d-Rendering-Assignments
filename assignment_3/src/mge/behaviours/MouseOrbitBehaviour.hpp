...
public:
	...
	MouseOrbitBehaviour(GameObject* pTarget, float distance = 4, float pSensitivity = 0.1, float pMinVerticalAnglefloat = -45, float pMaxVerticalAngle = 45, float pMinZoom = 4, float pMaxZoom = 100);
